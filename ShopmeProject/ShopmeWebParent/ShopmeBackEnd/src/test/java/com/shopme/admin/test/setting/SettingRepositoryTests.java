...
import com.shopme.admin.repository.setting.SettingRepository;
...
//        assertThat(savedSetting).isNotNull();
        Setting siteLogo =  new Setting("SITE_LOGO", "ShopmeLogo2.png", SettingCategory.GENERAL);
        ...
        Iterable<Setting> findAll = settingRepository.findAll();
