...
public class CategoryService {
    ...
    public  static final int TOP_CATEGORIES_PER_PAGE=4;
    public List<Category> listByPage(CategoryPageInfo pageInfo,int pageNum, String sortDir, String keyword){
        ...
        Pageable pageable = PageRequest.of(pageNum-1,TOP_CATEGORIES_PER_PAGE, sort);
    ...
    public Category get(Integer id) throws CategoryNotFindExeption {
        try {
            return categoryRepository.findById(id).get();
        }catch(NoSuchElementException ex){
            throw new CategoryNotFindExeption("Could not find any Category with ID "+id);
        }
    }
    ...
    public void delete(Integer id) throws CategoryNotFindExeption {
        Long countById = categoryRepository.countById(id);

        if(countById == null || countById==0){
            throw new CategoryNotFindExeption("There is no category with ID "+id);
        }
