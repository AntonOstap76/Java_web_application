...
public class BrandController {
   ...
   private BrandService brandService;
    ...
    public String newBrand(Model model){
        ...
        List<Category> categoriesUsedInForm=categoryService.listCategoriesUsedInForm();

        model.addAttribute("brand", new Brand());
        model.addAttribute("categoriesUsedInForm", categoriesUsedInForm);
    ...
    @GetMapping("/brands/delete/{id}")
        ...
        try{
            ...
            ra.addFlashAttribute("message", "The brand with ID "+id+" is successfully deleted");
    ...
    public void exportToCSV(HttpServletResponse response) throws IOException {
        List<Brand> blandList = brandService.listAll();
        BrandCSVExporter exporter = new BrandCSVExporter();
        exporter.export(blandList,response);
    }
}
