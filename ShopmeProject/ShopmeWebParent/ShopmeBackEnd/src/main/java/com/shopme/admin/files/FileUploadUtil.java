package com.shopme.admin.files;
...
public class FileUploadUtil {
    ...
    public static void cleanDir(String dir){
        ...
        try{
            ...
            LOGGER.error("Could not delete the file: "+ "Could not list directory: "+ dirPath);
    ...
    public static void removeDir(String categoryDir) {
        ...
        try{
            ...
            LOGGER.error("Can not remove directory: "+categoryDir);
        }
    }
}
